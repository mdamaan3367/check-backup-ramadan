  ...
  return (
    <View style={styles.serviceDetails}>
      ...
      <Text style={[styles.aServiceProvided, styles.aServiceProvidedTypo]}>
        A service provided by PROFM that aims to provide the necessary nutrients
        to plants and promote their healthy growth.
      </Text>
...
export default ServiceDetails16;
