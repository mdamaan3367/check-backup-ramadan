...
const CleaningAndSterilizingTheP22 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432748.png")}
      />
...
const styles = StyleSheet.create({
  ...
  aServiceAimedAtFixingAnyParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP22;
