      ...
      <View style={styles.serviceDetails}>
        <View style={[styles.frameParent, styles.parentPosition]}>
          ...
          >
            ...
            <Text style={[styles.theCompanyIs, styles.theTypo2]}>
        ...
        <Text style={[styles.checkingTheThermostat, styles.theTypo1]}>
          Checking the thermostat
        </Text>
        <Text style={[styles.checkTheAir, styles.checkTheAirPosition]}>
          Check the air conditioner thermostat. The thermostat must be intact to
          ensure that the air conditioner is working properly.
        </Text>
        <View style={[styles.serviceDetailsItem, styles.checkTheAirPosition]} />
        <View style={[styles.frameGroup, styles.frameGroupPosition]}>
          <View
            style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
          >
            <Text style={styles.theTypo}>Check the thermostat</Text>
            <Text style={[styles.adjustTheThermostat, styles.theTypo]}>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-43274.png")}
          />
          <Pressable
...
export default ServiceDetails561;
