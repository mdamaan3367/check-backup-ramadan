...
const ServiceDetails36 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.serviceDetails}>
      <View style={[styles.serviceDetailsChild, styles.framePosition]} />
      <Text style={[styles.checkWaterPressure, styles.servicesProvidedTypo]}>
        Check water pressure
      </Text>
      <Text style={[styles.aServiceProvidedContainer, styles.homeTypo1]}>
        {`A service provided by `}
        <Text style={styles.profm}>Profm</Text> to ensure the safety and
        efficiency of the building's water system.
      </Text>
      ...
      <View style={styles.rectangleParent}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-432771.png")}
        />
...
export default ServiceDetails36;
