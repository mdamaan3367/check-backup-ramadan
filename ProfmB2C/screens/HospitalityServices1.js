...
const HospitalityServices1 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.hospitalityServices}>
      <Image
        style={styles.hospitalityServicesChild}
        resizeMode="cover"
        source={require("../assets/rectangle-432723.png")}
      />
      ...
      <View style={styles.qualifiedStaffToServeCoffeParent}>
        <Text
          style={styles.qualifiedStaffTo}
        >{`Qualified staff to serve coffee, tea and various beverages to the
employees and guests in a professional and courteous manner`}</Text>
        <Text style={[styles.providingCoffeeTea, styles.text10Layout]}>
          Providing coffee, tea and drinks
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentPosition1]}
          onPress={() => navigation.navigate("ServiceDetails12")}
        >
      ...
      <View style={[styles.groupParent, styles.parentPosition1]}>
        <View style={styles.lineParent}>
          ...
          <View style={[styles.frameContainer, styles.groupChildPosition]}>
            ...
            <Text style={[styles.booking, styles.hoursTypo]}>{`Booking `}</Text>
          </View>
          ...
          <View style={[styles.frameWrapper, styles.groupChildShadowBox]}>
            <View>
              ...
              <View style={styles.groupParent2}>
                ...
                <View style={[styles.group, styles.groupLayout1]}>
                  <Text style={[styles.text10, styles.sunSpaceBlock]}>20</Text>
          ...
          <View style={[styles.rectangleGroup, styles.groupLayout]}>
            ...
            <View style={[styles.frameParent2, styles.parentPosition]}>
              <View style={styles.periodOfServiceParent}>
                <Text style={styles.periodOfService}>period of service</Text>
        ...
        <View style={[styles.rectangleContainer, styles.groupChildLayout]}>
          ...
          <View style={[styles.numberOfWorkersParent, styles.parentPosition]}>
            <Text style={styles.periodOfService}>start time</Text>
      ...
      <View style={styles.hospitalityServicesItem} />
...
const styles = StyleSheet.create({
  ...
  qualifiedStaffToServeCoffeParent: {
    top: 208,
    height: 176,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default HospitalityServices1;
