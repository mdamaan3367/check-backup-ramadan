...
const CleaningAndSterilizingTheP3 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-43277.png")}
      />
      ...
      <View style={styles.addingOilToSomeAirConditiParent}>
        <Text style={[styles.addingOilTo, styles.addingOilToTypo]}>
          Adding oil to some air conditioner components to ensure they work
          properly.
        </Text>
        <Text style={styles.airConditionerLubrication}>
          Air conditioner lubrication
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails4")}
        >
...
const styles = StyleSheet.create({
  ...
  addingOilToSomeAirConditiParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP3;
