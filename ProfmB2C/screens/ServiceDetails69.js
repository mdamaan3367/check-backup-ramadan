  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text
          style={[styles.cuttingAndTrimming, styles.cuttingAndTrimmingTypo]}
        >
        ...
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          ...
          >
            ...
            <Text style={[styles.removeBranchesThat, styles.thatTypo]}>
              Thinning the branches to encourage light and air to enter the
              tree.
            </Text>
            <Text style={[styles.anyOtherNatural, styles.anyOtherNaturalTypo]}>
...
export default ServiceDetails69;
