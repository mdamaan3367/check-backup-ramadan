...
const CleaningAndSterilizingTheP42 = () => {
    ...
    <>
      <View style={styles.cleaningAndSterilizingTheP}>
        ...
        <View style={styles.importantMaintenanceForAirParent}>
          ...
          <Text style={styles.changingDamagedBelts}>
            Changing damaged belts
          </Text>
          <Pressable
            style={[styles.frameParent, styles.parentGroupPosition]}
            onPress={() => navigation.navigate("ServiceDetails61")}
          >
...
export default CleaningAndSterilizingTheP42;
