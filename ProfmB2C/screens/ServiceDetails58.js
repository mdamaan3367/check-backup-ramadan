  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text
          style={[
            styles.airConditionerLubrication,
            styles.theBestSpecializedTypo,
          ]}
        >
          Air conditioner lubrication
        </Text>
        <Text style={[styles.aMaintenanceService, styles.servicePosition]}>
          A maintenance service in which the air conditioner motors and bearings
          are checked and oiled or greased as needed.
        </Text>
        ...
        <View style={[styles.frameGroup, styles.frameGroupPosition]}>
          <View
            style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
          >
            <Text style={styles.motorsTypo}>
              Inspecting motors and bearings
            </Text>
            <Text style={[styles.lubricationOfMotors, styles.motorsTypo]}>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-43278.png")}
          />
          <Pressable
...
export default ServiceDetails58;
