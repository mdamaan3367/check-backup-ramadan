...
const CleaningAndSterilizingTheP = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-43271.png")}
      />
      ...
      <View style={styles.removingDirtAndDebrisFromParent}>
        <Text style={[styles.removingDirtAnd, styles.serviceDetailsTypo]}>
          Removing Dirt and Debris from Your Air Conditioner's diffuser must be
          clean to ensure effective air distribution.
        </Text>
        <Text style={styles.cleaningAirDiffusers}>Cleaning air diffusers</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails1")}
        >
...
const styles = StyleSheet.create({
  ...
  removingDirtAndDebrisFromParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP;
