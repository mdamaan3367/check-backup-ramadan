...
const FiltrationSystemMaintenance = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.filtrationSystemMaintenance}>
      <Image
        style={styles.filtrationSystemMaintenanceChild}
        resizeMode="cover"
        source={require("../assets/rectangle-432760.png")}
      />
      ...
      <View style={styles.inspectRepairAndMaintainTParent}>
        <Text style={[styles.inspectRepairAnd, styles.serviceDetailsTypo]}>
          Inspect, repair and maintain the filtration system in a swimming pool
          or any other system used to purify water
        </Text>
        <Text style={styles.filtrationSystemMaintenance1}>
          Filtration system maintenance
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails31")}
        >
      ...
      <View
        style={[
          styles.filtrationSystemMaintenanceItem,
        ...
        <View style={styles.selectDateParent}>
          <View style={styles.warning2Layout}>
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/warning21.png")}
            />
      ...
      <View style={[styles.buttonBigParent, styles.homeIndicatorSpaceBlock]}>
        <Pressable
          ...
          onPress={() => navigation.navigate("YourAddressLocation6")}
        >
        ...
        <View style={styles.sarParent}>
          <Text style={[styles.sar, styles.amTypo]}>40 SAR</Text>
...
const styles = StyleSheet.create({
  ...
  filtrationSystemMaintenanceChild: {
    height: 208,
    width: 375,
    left: 0,
    top: 0,
  ...
  inspectRepairAndMaintainTParent: {
    top: 208,
    height: 176,
    overflow: "hidden",
    backgroundColor: Color.whait,
  ...
  filtrationSystemMaintenanceItem: {
    marginLeft: -168.5,
    top: 1067,
    width: 338,
    height: 37,
...
export default FiltrationSystemMaintenance;
