  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        <View style={[styles.serviceDetailsChild, styles.frameGroupPosition]} />
        <Text style={[styles.checkTheFan, styles.theTypo]}>
          Check the fan motors
        </Text>
        <Text
          style={[styles.maintenanceInWhich, styles.maintenanceInWhichPosition]}
        >
          Maintenance in which the fan motors in the air conditioning unit are
          checked to ensure they are working properly.
        </Text>
        <View
          style={[styles.serviceDetailsItem, styles.maintenanceInWhichPosition]}
        />
        <View style={[styles.frameGroup, styles.frameGroupPosition]}>
          <View
            style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
          >
            <Text style={styles.checkFanMotorsTypo}>Check fan motors</Text>
            <Text style={[styles.repairOrReplace, styles.checkFanMotorsTypo]}>
              Repair or replace fan motors
            </Text>
          </View>
          <Text style={styles.servicesExclude}>Services provided</Text>
        </View>
        <View style={[styles.navBarParent, styles.parentPosition]}>
            ...
            >
              <View style={styles.calendarTickParent}>
                <Image
                  style={styles.home2Icon}
                  resizeMode="cover"
                  source={require("../assets/calendartick9.png")}
                />
          ...
          <View style={[styles.webViewbottom, styles.parentPosition]}>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-43276.png")}
          />
          <Pressable
...
export default ServiceDetails57;
