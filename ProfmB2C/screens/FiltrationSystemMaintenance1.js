...
const FiltrationSystemMaintenance1 = () => {
      ...
      <View style={styles.filtrationSystemMaintenance}>
        ...
        <View style={styles.inspectRepairAndMaintainTParent}>
          <Text style={[styles.inspectRepairAnd, styles.serviceDetailsTypo]}>
            Inspect, repair and maintain the filtration system in a swimming
            pool or any other system used to purify water
          </Text>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ServiceDetails87")}
          >
...
export default FiltrationSystemMaintenance1;
