  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        />
        <Text style={[styles.preparationOfAll, styles.preparationOfAllTypo]}>
          Preparation of all soft drinks
        </Text>
        <Text style={[styles.profmOffersAContainer, styles.homeTypo1]}>
          <Text style={styles.profm}>Profm</Text>
          {` offers a convenient beverage service with coffee, tea, and hot or cold drinks, perfect for hotels, offices, or any event.
`}
        </Text>
        <View style={[styles.frameParent, styles.frameParentPosition]}>
          <View
            style={[
              styles.preparingCoffeeTeaHotAndParent,
              styles.webViewbottomPosition,
            ]}
          >
            <Text style={styles.preparingCoffeeTea}>
              Preparing coffee, tea, hot and cold drinks
            </Text>
          ...
          <Text style={[styles.servicesProvided, styles.preparationOfAllTypo]}>
            Services provided
          </Text>
        </View>
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          ...
          >
            <Text
              style={styles.preparingCoffeeTea}
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-432782.png")}
          />
...
const styles = StyleSheet.create({
  ...
  preparingCoffeeTeaHotAndParent: {
    left: 16,
  },
  servicesProvided: {
    top: 24,
...
export default ServiceDetails67;
