  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        />
        <Text style={[styles.openClosedDoors, styles.openClosedDoorsTypo]}>
          Open closed doors
        </Text>
        <Text style={[styles.itIsA, styles.homeTypo1]}>
          It is a service aimed at fixing faults that prevent doors from opening
          properly.
        </Text>
        ...
        <View style={[styles.frameParent, styles.frameParentPosition]}>
          <View
            style={[
              styles.inspectTheDoorForAnySignsParent,
              styles.webViewbottomPosition,
            ]}
          >
            <Text style={[styles.inspectTheDoor, styles.allTypesOfTypo]}>
              Inspect the door for any signs of damage or breakage.
            </Text>
            <Text style={[styles.repairAnyFaults, styles.allTypesOf1Typo]}>
              Repair any faults in hinges or locks.
            </Text>
            <Text style={[styles.repairAnyFaults, styles.allTypesOf1Typo]}>
              Adjust the position of the door if it is curved or uneven.
            </Text>
            <Text style={[styles.repairAnyFaults, styles.allTypesOf1Typo]}>
              Install any damaged or missing parts.
            </Text>
          </View>
          <Text style={[styles.servicesProvided, styles.openClosedDoorsTypo]}>
            Services provided
          </Text>
        </View>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-432753.png")}
          />
...
const styles = StyleSheet.create({
  ...
  inspectTheDoorForAnySignsParent: {
    left: 16,
  },
  servicesProvided: {
    top: 24,
...
export default ServiceDetails83;
