  ...
  return (
    <>
      <View style={styles.facadeCleaning}>
        ...
        />
        <View
          style={[styles.theProcessOfRemovingDirtParent, styles.frameWrapperBg]}
        >
...
`}</Text>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ServiceDetails40")}
          >
            ...
            >
              <View style={styles.calendarTickParent}>
                <Image
                  style={styles.home2Icon1}
                  resizeMode="cover"
                  source={require("../assets/calendartick5.png")}
                />
      ...
      <Modal animationType="fade" transparent visible={viewDetailsTextVisible}>
        <View style={styles.viewDetailsTextOverlay}>
          ...
          />
          <ViewDetails onClose={closeViewDetailsText} />
        </View>
      </Modal>
    </>
  );
...
export default FacadeCleaning2;
