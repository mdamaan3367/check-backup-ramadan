    ...
    <View style={styles.pinYourLocation}>
        ...
        <View style={styles.rectangleLayout}>
          ...
          <View style={[styles.frameGroup, styles.writeHerePosition]}>
            <View style={styles.receiptEditParent}>
              ...
              />
              <Text
                style={[styles.subscriptionForOneContainer, styles.oneLayout]}
              >
            ...
            <View style={styles.frameContainer}>
              <View>
                <View style={styles.parentFlexBox}>
                  ...
                  />
                  <Text style={[styles.visits, styles.oneLayout]}>
                ...
                <View style={[styles.clockParent, styles.parentFlexBox]}>
                  ...
                  />
                  <Text style={[styles.hours, styles.oneLayout]}>
              ...
              <View>
                <View style={styles.userParent}>
                  ...
                  />
                  <Text style={[styles.domesticWorker, styles.oneLayout]}>
                ...
                <View style={styles.home2Parent}>
                  ...
                  />
                  <Text style={[styles.oneVisitA, styles.oneLayout]}>
                    One visit a week
                  </Text>
                </View>
              </View>
      ...
      <View style={[styles.buttonBigParent, styles.homeIndicatorSpaceBlock]}>
        ...
        <View style={styles.sarParent}>
          <Text style={styles.sar}>2600 SAR</Text>
...
export default PinYourLocation8;
