...
const CleaningAndSterilizingTheP15 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432734.png")}
      />
      ...
      <View style={styles.aServiceThatAimsToMaintaiParent}>
        ...
        <Text style={styles.mulchTheLawn}>Mulch the lawn regularly</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails18")}
        >
...
export default CleaningAndSterilizingTheP15;
