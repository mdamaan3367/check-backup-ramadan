...
const ServiceDetails25 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.serviceDetails}>
      <View style={[styles.serviceDetailsChild, styles.framePosition]} />
      <Text style={[styles.curtainIssues, styles.curtainIssuesTypo]}>
        Curtain issues
      </Text>
      <Text style={[styles.aServiceAimed, styles.homeTypo1]}>
        A service aimed at fixing any problems that curtains may encounter at
        home
      </Text>
      <View style={[styles.frameParent, styles.framePosition]}>
        <View
          style={[
            styles.inspectTheBlindsForAnySigParent,
            styles.webViewbottomPosition,
          ]}
        >
          <Text style={[styles.inspectTheBlinds, styles.allTypesOfTypo]}>
            Inspect the blinds for any signs of damage or breakage.
          </Text>
          <Text style={[styles.repairAnyMalfunctions, styles.allTypesOf1Typo]}>
            Repair any malfunctions in bars or rings.
          </Text>
          <Text style={[styles.repairAnyMalfunctions, styles.allTypesOf1Typo]}>
            Adjust the position of curtains if they are hung incorrectly.
          </Text>
          <Text style={[styles.repairAnyMalfunctions, styles.allTypesOf1Typo]}>
            Install any damaged or missing parts.
          </Text>
        </View>
        <Text style={[styles.servicesProvided, styles.curtainIssuesTypo]}>
          Services provided
        </Text>
      </View>
      ...
      <View style={styles.rectangleParent}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-432749.png")}
        />
...
const styles = StyleSheet.create({
  ...
  repairAnyMalfunctions: {
    width: 329,
  },
  inspectTheBlindsForAnySigParent: {
    left: 16,
  },
  servicesProvided: {
    top: 24,
...
export default ServiceDetails25;
