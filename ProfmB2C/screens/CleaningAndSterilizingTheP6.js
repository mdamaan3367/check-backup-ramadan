...
const CleaningAndSterilizingTheP6 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432713.png")}
      />
      ...
      <View style={styles.importantMaintenanceForAirParent}>
        <Text
          style={[styles.importantMaintenanceFor, styles.serviceDetailsTypo]}
        >
          Important maintenance for air conditioners, as it helps ensure that
          the air conditioner is working properly.
        </Text>
        <Text style={styles.changingDamagedBelts}>Changing damaged belts</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails7")}
        >
...
const styles = StyleSheet.create({
  ...
  importantMaintenanceForAirParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP6;
