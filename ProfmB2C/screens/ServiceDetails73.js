    ...
    <>
      <View style={styles.serviceDetails}>
        ...
        <View style={[styles.frameParent, styles.frameParentPosition]}>
          ...
          >
            <Text style={[styles.allTypeOf, styles.allTypeOfClr]}>
            ...
            <Text style={[styles.replacingDamagedTrees, styles.andTypo]}>
        ...
        <Text style={[styles.trimmingShrubsAnd, styles.trimmingShrubsAndTypo]}>
          Trimming shrubs and plant hedges
        </Text>
        <Text style={[styles.aServiceProvided, styles.andTypo]}>
          A service provided by PROFM to maintain the aesthetic appearance of
          shrubs and plant hedges.
        </Text>
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          <View
            style={[styles.allTypeOfSparePartsParent, styles.wrapperPosition]}
          >
            <Text style={[styles.inspectShrubsAnd, styles.andTypo]}>
              Inspect shrubs and plant hedges to ensure they are safe and free
              of any damage or disease.
            </Text>
            <Text style={[styles.cutAndShape, styles.andTypo]}>
              Cut and shape shrubs and plant hedges as desired, to maintain
              their beautiful shape and promote healthy growth.
            </Text>
            <Text style={[styles.cutAndShape, styles.andTypo]}>
              Remove any dead or infected branches from shrubs and plant hedges.
            </Text>
            <Text style={[styles.cutAndShape, styles.andTypo]}>
              Remove any weeds or weeds from around shrubs and plant hedges.
            </Text>
          </View>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-432733.png")}
          />
          <Pressable
          ...
          <View style={styles.profmLogo1111Parent}>
            ...
            />
            <Text
              style={[styles.theBestSpecialized, styles.trimmingShrubsAndTypo]}
            >
...
export default ServiceDetails73;
