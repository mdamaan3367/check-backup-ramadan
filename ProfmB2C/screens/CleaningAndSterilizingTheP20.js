...
const CleaningAndSterilizingTheP20 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432744.png")}
      />
      ...
      <View style={styles.aServiceAimedAtInstallingParent}>
        <Text style={[styles.aServiceAimed, styles.serviceTypo]}>
          A service aimed at installing or replacing rubber gaskets around
          windows and doors to improve insulation.
        </Text>
        <Text style={styles.rubberGasketWorks}>Rubber gasket works</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails23")}
        >
...
const styles = StyleSheet.create({
  ...
  aServiceAimedAtInstallingParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP20;
