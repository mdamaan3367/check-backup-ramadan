...
const CleaningAndSterilizingTheP17 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432738.png")}
      />
      ...
      <View style={styles.distributingElectricalLoadsParent}>
        <Text
          style={[
        ...
        >
          Distributing electrical loads in a balanced manner across all
          electrical components in the system, which reduces the risk of
          electrical malfunctions or outages.
        </Text>
        <Text style={styles.distributionOfElectrical}>
          Distribution of electrical loads
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails20")}
        >
...
const styles = StyleSheet.create({
  ...
  distributingElectricalLoadsParent: {
    top: 208,
    height: 198,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP17;
