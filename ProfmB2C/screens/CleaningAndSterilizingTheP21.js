...
const CleaningAndSterilizingTheP21 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432746.png")}
      />
      ...
      <View style={styles.aServiceAimedAtFixingAnyParent}>
        ...
        <Text style={styles.wardrobeIssues}>Wardrobe issues</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails24")}
        >
...
export default CleaningAndSterilizingTheP21;
