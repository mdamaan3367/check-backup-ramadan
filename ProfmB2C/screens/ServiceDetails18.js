    ...
    <View style={styles.serviceDetails}>
      <View style={[styles.frameParent, styles.framePosition]}>
        ...
        >
          ...
          <Text style={[styles.replacingDamagedTrees, styles.aServiceThatTypo]}>
      ...
      <Text style={[styles.aServiceThat, styles.aServiceThatTypo]}>
        A service that aims to maintain the beautiful and healthy appearance of
        the grass by adding a layer of organic materials.
      </Text>
      ...
      <View style={[styles.navBarSignUpParent, styles.navPosition]}>
        ...
        <View style={[styles.webViewbottom, styles.frameBg]}>
...
export default ServiceDetails18;
