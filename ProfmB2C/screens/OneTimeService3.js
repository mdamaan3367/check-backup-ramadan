...
const OneTimeService3 = () => {
  ...
  return (
    <View style={styles.oneTimeService}>
      ...
      <View style={[styles.oneTimeServiceChild, styles.framePosition]} />
      <View style={[styles.frameGroup, styles.framePosition]}>
        <Pressable
          style={[styles.rectangleGroup, styles.groupShadowBox]}
          onPress={() => navigation.navigate("RegularCleaning2")}
        >
          <LinearGradient
            ...
            angle={90}
          />
          <View style={[styles.regularCleaningParent, styles.arrow21Position]}>
            <Text style={[styles.regularCleaning, styles.cleaningTypo]}>
              Regular cleaning
            </Text>
            <Text style={[styles.ourExpertCleaningContainer, styles.homeTypo]}>
              <Text
...
`}</Text>
        ...
        <Pressable
          style={styles.framePressableShadowBox}
          onPress={() => navigation.navigate("DeepCleaning3")}
        >
          <LinearGradient
            style={[styles.frameChild, styles.groupItemPosition]}
            locations={[0, 1]}
        ...
        <Pressable
          style={styles.framePressableShadowBox}
          onPress={() => navigation.navigate("FacadeCleaning3")}
        >
          <LinearGradient
            style={[styles.frameChild, styles.groupItemPosition]}
            locations={[0, 1]}
      ...
      >
        ...
        >
          ...
          <View style={[styles.rectangleParent1, styles.groupInnerLayout]}>
            ...
            <Image
              style={[styles.profmLogo1111, styles.framePosition]}
              resizeMode="cover"
...
export default OneTimeService3;
