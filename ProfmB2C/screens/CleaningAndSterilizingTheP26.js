...
const CleaningAndSterilizingTheP26 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432756.png")}
      />
      ...
      <View style={styles.profmKeepsYourPoolWaterSaParent}>
        <Text style={[styles.profmKeepsYourContainer, styles.writeHereTypo]}>
          <Text style={styles.profm}>Profm</Text>
          {` keeps your pool water safe & comfortable! Maintains PH levels within limits`}
        </Text>
        <Text
          style={styles.maintainingSalinityPh}
        >{`Maintaining salinity (PH) `}</Text>
        <Pressable
          style={[styles.frameParent, styles.parentPosition]}
          onPress={() => navigation.navigate("ServiceDetails29")}
        >
...
const styles = StyleSheet.create({
  ...
  profmKeepsYourPoolWaterSaParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP26;
