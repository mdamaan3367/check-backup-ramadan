...
const ServiceDetails19 = () => {
  ...
  return (
    <View style={styles.serviceDetails}>
      ...
      <Text
        style={[styles.inspectionAndMaintenance, styles.servicesProvidedTypo]}
      >
        Inspection and maintenance of electrical boxes
      </Text>
      <Text
        style={[styles.ensuringTheSafety, styles.homeTypo1]}
      >{`Ensuring the safety and efficiency of electrical boxes, thus protecting people and property from electrical hazards.
`}</Text>
      ...
      <View style={styles.rectangleParent}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-432737.png")}
        />
...
export default ServiceDetails19;
