  ...
  return (
    <>
      <View style={styles.regularCleaning}>
        ...
        <View style={styles.profmProvidesComprehensiveSParent}>
          <Text style={styles.profmProvidesComprehensiveContainer}>
            <Text style={styles.profm}>{`Profm `}</Text>
            <Text style={styles.providesComprehensiveService}>
              provides comprehensive services to companies and organizations
              from all over the world
            </Text>
          </Text>
          <Text style={[styles.receptionistServices, styles.text10Layout]}>
            Receptionist Services
          </Text>
          <Pressable
            style={[styles.frameParent, styles.parentPosition1]}
            onPress={() => navigation.navigate("ServiceDetails65")}
          >
...
const styles = StyleSheet.create({
  ...
  providesComprehensiveService: {
    textTransform: "capitalize",
  },
  profmProvidesComprehensiveContainer: {
    top: 56,
    lineHeight: 18,
    width: 344,
    height: 32,
  ...
  profmProvidesComprehensiveSParent: {
    top: 208,
    height: 176,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default RegularCleaning5;
