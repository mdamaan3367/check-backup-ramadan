...
const CleaningAndSterilizingTheP11 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432727.png")}
      />
      ...
      <View style={styles.aServiceThatAimsToMaintaiParent}>
        ...
        <Text style={styles.irrigationNetworkMaintenance}>
          Irrigation network maintenance
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails14")}
        >
...
export default CleaningAndSterilizingTheP11;
