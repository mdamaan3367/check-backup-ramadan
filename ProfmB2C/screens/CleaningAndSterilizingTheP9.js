...
const CleaningAndSterilizingTheP9 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432719.png")}
      />
      ...
      <View style={styles.maintenanceServiceForAllTyParent}>
        <Text style={[styles.maintenanceServiceFor, styles.serviceTypo]}>
          Maintenance service for all types of air conditioners at competitive
          prices by specialists
        </Text>
        <Text style={styles.airConditionerMaintenance}>
          Air conditioner maintenance
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails10")}
        >
...
const styles = StyleSheet.create({
  ...
  maintenanceServiceForAllTyParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP9;
