...
const CleaningAndSterilizingTheP7 = () => {
    ...
    <View style={styles.cleaningAndSterilizingTheP}>
      ...
      <View style={styles.removingDirtFromAirConditiParent}>
        <Text style={[styles.removingDirtFrom, styles.serviceDetailsTypo]}>
          Removing dirt from air conditioner condenser coils These coils must be
          free of dirt to ensure effective heat transfer.
        </Text>
        <Text
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("ServiceDetails8")}
        >
...
export default CleaningAndSterilizingTheP7;
