...
const CleaningAndSterilizingTheP16 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432736.png")}
      />
      ...
      <View style={styles.ensuringTheSafetyAndEfficiParent}>
        <Text style={[styles.ensuringTheSafety, styles.serviceDetailsTypo]}>
          Ensuring the safety and efficiency of electrical boxes, thus
          protecting people and property from electrical hazards.
        </Text>
        <Text style={[styles.inspectionAndMaintenance, styles.amClr]}>
          Inspection and maintenance of electrical boxes
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails19")}
        >
...
const styles = StyleSheet.create({
  ...
  ensuringTheSafetyAndEfficiParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP16;
