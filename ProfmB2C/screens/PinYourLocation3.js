...
const PinYourLocation3 = () => {
  ...
  return (
    <View style={styles.pinYourLocation}>
      ...
      <Text style={[styles.bookingTheService, styles.logInFlexBox]}>
        Booking the service
      </Text>
      ...
      <View style={styles.groupParent1}>
        ...
        <View style={styles.frameWrapper}>
          <View>
            <View>
              ...
              <View style={[styles.frameWrapper1, styles.childBorder]}>
                <View>
                  <View style={styles.receiptEditParent}>
                  ...
                  <View style={styles.groupParent2}>
                    <View style={[styles.parent, styles.groupLayout]}>
                      ...
                      <Text style={[styles.sun, styles.sunSpaceBlock]}>
                        SUN
                      </Text>
                    </View>
                    ...
                    <View style={[styles.group, styles.groupLayout]}>
                      <Text style={[styles.text16, styles.sunSpaceBlock]}>
                        20
                      </Text>
                      <Text style={[styles.sun, styles.sunSpaceBlock]}>
                        SAT
            ...
            <View style={styles.calendarTickParent}>
              <Image
                style={styles.calendarTickIcon}
                resizeMode="cover"
                source={require("../assets/calendartick7.png")}
              />
              <Text
                style={[styles.theContractBeginsContainer, styles.theLayout]}
              >
                <Text
                  style={styles.theContractBegins}
                >{`The contract begins on `}</Text>
                <Text style={[styles.january172024, styles.logInTypo]}>
                  January 17, 2024
                </Text>
                <Text style={styles.theContractBegins}>{` and ends on `}</Text>
                <Text style={[styles.january172024, styles.logInTypo]}>
                  January 18, 2025.
                </Text>
              </Text>
            ...
            <View style={[styles.time1, styles.timeLayout]}>
              ...
              <Text style={styles.to0100Position}>
                <Text style={styles.to0100PmContainer1}>
                  <Text
                    style={[styles.january172024, styles.logInTypo]}
                  >{`11:00  `}</Text>
                  <Text style={styles.visits1}>
                  ...
                  <Text style={styles.pm}>
                    ...
                    <Text
                      style={[styles.text19, styles.logInTypo]}
                    >{` 01:00  `}</Text>
        ...
        <View style={styles.calendarTickParent}>
          ...
          />
          <Text
            style={[styles.theAttendanceOf, styles.theLayout]}
...
`}</Text>
      ...
      <View style={[styles.buttonBigParent, styles.homeIndicatorSpaceBlock]}>
        ...
        <View style={styles.sarParent}>
          <Text style={styles.sar}>3700 SAR</Text>
...
export default PinYourLocation3;
