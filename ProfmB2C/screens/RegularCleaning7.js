    ...
    <>
      <View style={styles.regularCleaning}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-432781.png")}
        />
        ...
        <View style={styles.qualifiedStaffPreparesCoffeParent}>
          <Text style={styles.qualifiedStaffPreparesContainer}>
            <Text style={styles.q}>q</Text>ualified staff prepares coffee, tea,
            and various soft and cold drinks for the hotel, employees, and
            guests in a professional and polite manner
          </Text>
          <Text style={[styles.preparationOfAll, styles.text10Layout]}>
            Preparation of all soft drinks
          </Text>
          <Pressable
            style={[styles.frameParent, styles.parentPosition1]}
            onPress={() => navigation.navigate("ServiceDetails67")}
          >
...
const styles = StyleSheet.create({
  ...
  qualifiedStaffPreparesContainer: {
    top: 56,
    lineHeight: 18,
    width: 344,
    height: 54,
  ...
  qualifiedStaffPreparesCoffeParent: {
    top: 208,
    height: 198,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default RegularCleaning7;
