  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text
          style={[styles.generalInspectionOf, styles.theBestSpecializedTypo]}
        >
          General inspection of all air conditioning units
        </Text>
        <Text style={[styles.ensuringThatAir, styles.theCompanyIsLayout]}>
          Ensuring that air conditioning units operate properly and provide
        ...
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          <View
            style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
          >
            <Text style={styles.checkTheAirTypo}>Check the air filter</Text>
            <Text
              style={[styles.cleaningCondenserCoils, styles.checkTheAirTypo]}
            >
...
export default ServiceDetails53;
