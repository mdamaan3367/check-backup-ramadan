...
const CleaningAndSterilizingTheP24 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432752.png")}
      />
...
const styles = StyleSheet.create({
  ...
  itIsAServiceAimedAtFixinParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP24;
