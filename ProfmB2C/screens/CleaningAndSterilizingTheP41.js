...
const CleaningAndSterilizingTheP41 = () => {
    ...
    <>
      <View style={styles.cleaningAndSterilizingTheP}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-432711.png")}
        />
        ...
        <View style={styles.measureTheAmountOfRefrigerParent}>
          <Text style={[styles.measureTheAmount, styles.serviceDetailsTypo]}>
            Measure the amount of refrigerant gas present in the air
            conditioning system.
          </Text>
          <Text style={[styles.checkingTheLevel, styles.amClr]}>
            Checking the level of refrigerant gas (Freon)
          </Text>
          <Pressable
            style={[styles.frameParent, styles.parentGroupPosition]}
            onPress={() => navigation.navigate("ServiceDetails60")}
          >
...
const styles = StyleSheet.create({
  ...
  measureTheAmountOfRefrigerParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP41;
