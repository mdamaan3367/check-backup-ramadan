...
import ViewDetails1 from "../components/ViewDetails1";
...
`}</Text>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ServiceDetails41")}
          >
          ...
          <View style={styles.deepCleaning1Position}>
            ...
            <View style={[styles.frameParent2, styles.parentFlexBox]}>
              ...
              <Pressable
                ...
                onPress={() => navigation.navigate("PinYourLocation2")}
              >
      ...
      <Modal animationType="fade" transparent visible={viewDetailsTextVisible}>
        <View style={styles.viewDetailsTextOverlay}>
          ...
          />
          <ViewDetails1 onClose={closeViewDetailsText} />
        </View>
      </Modal>
    </>
  );
