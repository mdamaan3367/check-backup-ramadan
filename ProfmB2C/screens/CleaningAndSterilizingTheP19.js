...
const CleaningAndSterilizingTheP19 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432742.png")}
      />
      ...
      <View style={styles.aServiceAimedAtRepairingAParent}>
        ...
        <Text style={styles.otherLightCarpentry}>
          Other light carpentry work
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails22")}
        >
...
const styles = StyleSheet.create({
  ...
  aServiceAimedAtRepairingAParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP19;
