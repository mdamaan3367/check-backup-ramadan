...
const CleaningAndSterilizingTheP2 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-43275.png")}
      />
      ...
      <View style={styles.checkingTheSafetyAndEfficiParent}>
        <Text style={[styles.checkingTheSafety, styles.serviceDetailsTypo]}>
          Checking the safety and efficiency of the fan motors in the air
          conditioner.
        </Text>
        <Text style={styles.checkTheFan}>Check the fan motors</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails3")}
        >
...
const styles = StyleSheet.create({
  ...
  checkingTheSafetyAndEfficiParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP2;
