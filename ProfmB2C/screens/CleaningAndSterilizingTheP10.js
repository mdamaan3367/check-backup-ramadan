...
const CleaningAndSterilizingTheP10 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432725.png")}
      />
      ...
      <View style={styles.aServiceThatAimsToMaintaiParent}>
        <Text style={[styles.aServiceThat, styles.serviceTypo]}>
          A service that aims to maintain trees in good and healthy condition
          and promote their healthy growth.
        </Text>
        <Text style={styles.cuttingAndTrimming}>
          Cutting and trimming trees
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails13")}
        >
...
const styles = StyleSheet.create({
  ...
  aServiceThatAimsToMaintaiParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP10;
