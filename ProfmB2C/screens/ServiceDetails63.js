    ...
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text style={[styles.aMaintenanceService, styles.servicePosition]}>
          A maintenance service in which the air filter is removed from the air
          conditioning unit and cleaned or replaced.
        </Text>
        ...
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          <View
            style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
          >
            <Text style={styles.theTypo}>Check the air filter</Text>
            <Text style={[styles.cleanTheAir, styles.theTypo]}>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-432718.png")}
          />
          <Pressable
...
export default ServiceDetails63;
