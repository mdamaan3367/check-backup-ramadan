...
import { Text, StyleSheet, View, Image, Pressable, Modal, ScrollView } from "react-native";
      ...
      <View style={styles.oneTimeService}>
        ...
        <View style={[styles.frameParent, styles.parentPosition]}>
          <Pressable
            ...
            onPress={() => navigation.navigate("RegularCleaning")}
          >
            <LinearGradient
...
`}</Text>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("DeepCleaning1")}
          >
            <LinearGradient
              style={[styles.frameChild, styles.frameChildPosition]}
              locations={[0, 1]}
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("FacadeCleaning")}
          >
            <LinearGradient
              style={[styles.frameChild, styles.frameChildPosition]}
              locations={[0, 1]}
        ...
        <View style={[styles.navBarSignUpParent, styles.navLayout1]}>
      ...
      <Modal animationType="fade" transparent visible={frameContainer14Visible}>
        <View style={styles.frameContainer14Overlay}>
          ...
          />
          <ViewDetails61 onClose={closeFrameContainer14} />
        </View>
      </Modal>
      ...
      <Modal animationType="fade" transparent visible={frameContainer22Visible}>
        <View style={styles.frameContainer22Overlay}>
          ...
          />
          <ViewDetails51 onClose={closeFrameContainer22} />
        </View>
      </Modal>
      ...
      <Modal animationType="fade" transparent visible={frameContainer30Visible}>
        <View style={styles.frameContainer30Overlay}>
          ...
          />
          <ViewDetails41 onClose={closeFrameContainer30} />
        </View>
      </Modal>
      </ScrollView>
    </>
