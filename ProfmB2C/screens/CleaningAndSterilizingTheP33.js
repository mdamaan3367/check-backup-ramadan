...
const CleaningAndSterilizingTheP33 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432776.png")}
      />
      ...
      <View style={styles.ensuringThatAirConditioningParent}>
        <Text style={[styles.ensuringThatAir, styles.serviceDetailsTypo]}>
          Ensuring that air conditioning units operate properly and provide
          maximum comfort and efficiency
        </Text>
        <Text style={[styles.generalInspectionOf, styles.amClr]}>
...
const styles = StyleSheet.create({
  ...
  ensuringThatAirConditioningParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP33;
