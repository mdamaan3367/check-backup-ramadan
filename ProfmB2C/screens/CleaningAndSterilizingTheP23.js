...
const CleaningAndSterilizingTheP23 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432750.png")}
      />
...
const styles = StyleSheet.create({
  ...
  aServiceAimedAtReplacingDParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP23;
