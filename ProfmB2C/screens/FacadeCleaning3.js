...
import ViewDetails3 from "../components/ViewDetails3";
import { Color, FontFamily, FontSize, Padding, Border } from "../GlobalStyles";

const FacadeCleaning3 = () => {
  ...
  return (
    <>
      <View style={styles.facadeCleaning}>
        ...
        />
        <View
          style={[styles.theProcessOfRemovingDirtParent, styles.navBarSignUpBg]}
        >
...
`}</Text>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ServiceDetails43")}
          >
            ...
            <View style={styles.frameViewPosition}>
              ...
              <View style={[styles.frameParent3, styles.parentFlexBox]}>
                ...
                <Pressable
                  ...
                  onPress={() => navigation.navigate("PinYourLocation9")}
                >
          ...
          <View style={[styles.frameWrapper2, styles.frameWrapperLayout]}>
            <View style={styles.frameViewPosition}>
              ...
              <View style={[styles.frameParent3, styles.parentFlexBox]}>
                ...
                <Pressable
                  style={styles.groupChildLayout}
                  onPress={() => navigation.navigate("PinYourLocation8")}
                >
                  <View style={[styles.groupChild, styles.groupChildLayout]} />
                  <Text style={[styles.bookNow, styles.bookNowFlexBox]}>
                    Book Now
          ...
          <View style={[styles.frameWrapper2, styles.frameWrapperLayout]}>
            <View style={styles.frameViewPosition}>
              ...
              <View style={[styles.frameParent3, styles.parentFlexBox]}>
                ...
                <Pressable
                  style={styles.groupChildLayout}
                  onPress={() => navigation.navigate("PinYourLocation7")}
                >
                  <View style={[styles.groupChild, styles.groupChildLayout]} />
                  <Text style={[styles.bookNow, styles.bookNowFlexBox]}>
                    Book Now
          ...
          <View style={[styles.frameWrapper2, styles.frameWrapperLayout]}>
            <View style={styles.frameViewPosition}>
              ...
              <View style={[styles.frameParent3, styles.parentFlexBox]}>
                ...
                <Pressable
                  style={styles.groupChildLayout}
                  onPress={() => navigation.navigate("PinYourLocation6")}
                >
                  <View style={[styles.groupChild, styles.groupChildLayout]} />
                  <Text style={[styles.bookNow, styles.bookNowFlexBox]}>
                    Book Now
          ...
          <View style={[styles.frameWrapper2, styles.frameWrapperLayout]}>
            <View style={styles.frameViewPosition}>
              ...
              <View style={[styles.frameParent3, styles.parentFlexBox]}>
                ...
                <Pressable
                  style={styles.groupChildLayout}
                  onPress={() => navigation.navigate("PinYourLocation4")}
                >
                  <View style={[styles.groupChild, styles.groupChildLayout]} />
                  <Text style={[styles.bookNow, styles.bookNowFlexBox]}>
                    Book Now
...
export default FacadeCleaning3;
