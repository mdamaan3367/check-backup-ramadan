  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text
          style={[
            styles.airConditionerElectrical,
        ...
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          ...
          >
            <Text style={styles.theTypo}>
              Measure the voltage and frequency of the electrical current
              supplied to the air conditioner.
            </Text>
...
export default ServiceDetails52;
