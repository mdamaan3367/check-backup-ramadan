...
const OneTimeService1 = () => {
  ...
  return (
    <>
      <View style={[styles.oneTimeService, styles.iconLayout]}>
...
`}</Text>
            ...
            <Pressable
              ...
              onPress={() => navigation.navigate("DeepCleaning4")}
            >
              <LinearGradient
                style={[styles.frameChild, styles.childPosition]}
                locations={[0, 1]}
              ...
              >
                ...
                <Text style={[styles.beyondYourRegular, styles.homeTypo]}>
                  Beyond your regular cleaning routines, our trained
                  professionals go the extra mile to tackle forgotten areas and
                  hidden spots
                </Text>
              </View>
            </Pressable>
            <Pressable
              ...
              onPress={() => navigation.navigate("FacadeCleaning1")}
            >
              <LinearGradient
                style={[styles.frameChild, styles.childPosition]}
                locations={[0, 1]}
              ...
              >
                ...
                <Text style={[styles.forProfessionalGlass, styles.homeTypo]}>
                  For professional glass and stone facade cleaning services for
                  a striking appearance choose clean service
                </Text>
              </View>
            </Pressable>
          </View>
        ...
        <View style={[styles.oneTimeServiceInner, styles.navBarParentLayout]}>
          <View style={[styles.oneTimeServiceInner, styles.navBarParentLayout]}>
            ...
            <View style={[styles.rectangleParent1, styles.groupItemLayout]}>
              ...
              <Image
                style={[styles.profmLogo1111, styles.cleaningPosition]}
                resizeMode="cover"
      ...
      <Modal animationType="fade" transparent visible={frameContainer16Visible}>
        <View style={styles.frameContainer16Overlay}>
          ...
          />
          <RegularCleaning9 onClose={closeFrameContainer16} />
        </View>
      </Modal>
    </>
  );
...
export default OneTimeService1;
