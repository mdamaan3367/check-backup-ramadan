...
const CleaningAndSterilizingTheP31 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432770.png")}
      />
      ...
      <View style={styles.checkTheHotAndColdWaterPParent}>
        <Text style={[styles.checkTheHot, styles.checkTheHotTypo]}>
          Check the hot and cold water pressure at all water points in the
          building, to ensure that the water pressure is suitable for use.
        </Text>
        <Text style={styles.checkWaterPressure}>Check water pressure</Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails36")}
        >
...
const styles = StyleSheet.create({
  ...
  checkTheHotAndColdWaterPParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP31;
