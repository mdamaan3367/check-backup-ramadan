...
const CleaningAndSterilizingTheP32 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432774.png")}
      />
      ...
      <View style={styles.checkTheVoltageSuppliedToParent}>
        <Text style={[styles.checkTheVoltage, styles.serviceDetailsTypo]}>
          Check the voltage supplied to the air conditioner and the electrical
          current consumed by the air conditioner to ensure their safety.
        </Text>
        <Text style={[styles.airConditionerElectrical, styles.amClr]}>
          Air conditioner electrical check (voltage/amp)
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails46")}
        >
...
const styles = StyleSheet.create({
  ...
  checkTheVoltageSuppliedToParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP32;
