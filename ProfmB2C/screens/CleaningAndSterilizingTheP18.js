...
const CleaningAndSterilizingTheP18 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432740.png")}
      />
      ...
      <View style={styles.theNetworkCommunicationsCheParent}>
        <Text
          style={[styles.theNetworkCommunications, styles.serviceDetailsTypo]}
        >
          The network communications checking service is an important service to
          ensure the stability and efficiency of the network.
        </Text>
        <Text style={styles.checkNetworkConnections}>
          Check network connections
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails21")}
        >
...
const styles = StyleSheet.create({
  ...
  theNetworkCommunicationsCheParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP18;
