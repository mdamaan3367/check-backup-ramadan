  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        />
        <Text style={[styles.providingCoffeeTea, styles.servicesProvidedTypo]}>
          Providing coffee, tea and drinks
        </Text>
        <Text
          style={[styles.qualifiedStaffTo, styles.homeTypo1]}
...
employees and guests in a professional and courteous manner`}</Text>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-432724.png")}
          />
...
export default ServiceDetails68;
