...
const CleaningAndSterilizingTheP27 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432758.png")}
      />
      ...
      <View style={styles.anImportantCleaningServiceParent}>
        <Text style={[styles.anImportantCleaning, styles.writeHereTypo]}>
          An important cleaning service to remove dirt, leaves and debris from
          the bottom of the pool. There are several types of vacuum cleaners
          available for cleaning pools
        </Text>
        <Text style={styles.vacuumingThePool}>Vacuuming the pool</Text>
        <Pressable
          style={[styles.frameParent, styles.parentPosition]}
          onPress={() => navigation.navigate("ServiceDetails30")}
        >
      ...
      <View style={[styles.groupParent, styles.parentPosition]}>
        ...
        <View style={[styles.rectangleGroup, styles.groupLayout]}>
          ...
          <View style={[styles.startTimeParent, styles.writeHerePosition]}>
            <Text style={[styles.startTime, styles.logInTypo]}>start time</Text>
        ...
        <View style={styles.swimmingPoolSize}>
          <View style={[styles.swimmingPoolSizeChild, styles.childPosition]} />
          <View style={styles.frameParent2}>
            <View>
              ...
              <Text
                style={[styles.chooseTheApproximate, styles.bookingSpaceBlock]}
              >
...
const styles = StyleSheet.create({
  ...
  anImportantCleaningServiceParent: {
    top: 208,
    height: 198,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP27;
