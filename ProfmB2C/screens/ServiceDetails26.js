  ...
  return (
    <View style={styles.serviceDetails}>
      ...
      <Text style={[styles.aServiceAimed, styles.homeTypo1]}>
        A service aimed at replacing damaged or old door handles with new ones.
      </Text>
      <View style={[styles.frameParent, styles.framePosition]}>
        <View
          style={[styles.removeOldHandlesParent, styles.webViewbottomPosition]}
        >
...
export default ServiceDetails26;
