...
const CleaningAndSterilizingTheP61 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432754.png")}
      />
      ...
      <View style={styles.serviceAimedAtEliminatingVParent}>
        <Text style={[styles.serviceAimedAtContainer, styles.serviceTypo]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("ServiceDetails84")}
        >
      ...
      <View style={[styles.buttonBigParent, styles.homeIndicatorSpaceBlock]}>
        ...
        <View style={styles.sarParent}>
          <Text style={[styles.sar, styles.amTypo]}>450 SAR</Text>
...
const styles = StyleSheet.create({
  ...
  serviceAimedAtEliminatingVParent: {
    top: 208,
    height: 198,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP61;
