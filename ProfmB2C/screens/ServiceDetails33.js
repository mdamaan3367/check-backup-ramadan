...
const ServiceDetails33 = () => {
  ...
  return (
    <View style={styles.serviceDetails}>
      ...
      <Text
        style={[styles.swimmingPoolSterilization, styles.servicesProvidedTypo]}
      >
        Swimming pool sterilization
      </Text>
      <Text style={[styles.maintainingTheSafety, styles.homeTypo1]}>
        Maintaining the safety of the pool and preventing the spread of bacteria
        and viruses. Special chemicals are used to kill bacteria and viruses in
        pool water.
      </Text>
...
export default ServiceDetails33;
