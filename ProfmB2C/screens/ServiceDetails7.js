...
const ServiceDetails7 = () => {
  ...
  return (
    <View style={styles.serviceDetails}>
      ...
      <Text
        style={[styles.changingDamagedBelts, styles.theBestSpecializedTypo]}
      >
        Changing damaged belts
      </Text>
      <Text
        style={[
          styles.importantMaintenanceFor,
          styles.serviceDetailsItemLayout,
        ]}
      >
        Important maintenance for air conditioners, as it helps ensure that the
        air conditioner is working properly.
      </Text>
      <View
        style={[styles.serviceDetailsItem, styles.serviceDetailsItemLayout]}
      />
      <View style={[styles.frameGroup, styles.framePosition]}>
        <View
          style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
        >
          <Text style={styles.beltsTypo}>Check belts</Text>
          <Text style={[styles.removeDamagedBelts, styles.beltsTypo]}>
            Remove damaged belts
          </Text>
          <Text style={[styles.removeDamagedBelts, styles.beltsTypo]}>
      ...
      <View style={styles.rectangleParent}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-432714.png")}
        />
