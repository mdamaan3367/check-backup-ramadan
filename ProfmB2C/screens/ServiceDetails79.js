  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text style={[styles.rubberGasketWorks, styles.servicesProvidedTypo]}>
          Rubber gasket works
        </Text>
        ...
        <View style={[styles.frameParent, styles.framePosition]}>
          <View
            style={[
              styles.removeOldRubberGasketsParent,
              styles.webViewbottomPosition,
            ]}
          >
            <Text style={[styles.removeOldRubber, styles.allTypesOfTypo]}>
              Remove old rubber gaskets.
            </Text>
            <Text style={[styles.measureNewRubber, styles.allTypesOf1Typo]}>
              Measure new rubber gaskets to ensure fit.
            </Text>
            <Text style={[styles.measureNewRubber, styles.allTypesOf1Typo]}>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-432745.png")}
          />
...
export default ServiceDetails79;
