...
const CleaningAndSterilizingTheP13 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432731.png")}
      />
      ...
      <View style={styles.aServiceProvidedByProfmThParent}>
...
const styles = StyleSheet.create({
  ...
  aServiceProvidedByProfmThParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP13;
