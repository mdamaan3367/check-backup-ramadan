  ...
  return (
    <>
      <View style={styles.serviceDetails}>
        ...
        />
        <Text
          style={[styles.cleaningAirDiffusers, styles.theBestSpecializedTypo]}
        >
          Cleaning air diffusers
        </Text>
        <Text style={[styles.removingDirtAnd, styles.removingDirtAndLayout]}>
          Removing Dirt and Debris from Your Air Conditioner's diffuser must be
          clean to ensure effective air distribution.
        </Text>
        <View
          style={[styles.serviceDetailsItem, styles.removingDirtAndLayout]}
        />
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          <View
            style={[styles.inTheEventOfReplacingTheParent, styles.thePosition]}
          >
            <Text style={styles.airTypo}>Check air diffusers</Text>
            <Text style={[styles.cleanAirDiffusers, styles.airTypo]}>
              Clean air diffusers
            </Text>
            <Text style={[styles.cleanAirDiffusers, styles.airTypo]}>
              Reinstall the diffusers
            </Text>
          </View>
        ...
        <View style={[styles.rectangleParent, styles.navBarPosition]}>
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/rectangle-43272.png")}
          />
...
export default ServiceDetails54;
