    ...
    <View style={styles.pinYourLocation}>
        ...
        <View style={styles.rectangleLayout}>
          ...
          <View style={[styles.frameGroup, styles.writeHerePosition]}>
            <View style={styles.receiptEditParent}>
              ...
              />
              <Text
                style={[styles.subscriptionForOneContainer, styles.hoursLayout]}
              >
            ...
            <View style={styles.frameContainer}>
              <View>
                <View style={styles.parentFlexBox}>
                  ...
                  />
                  <Text style={[styles.visits, styles.hoursLayout]}>
                    <Text style={styles.subscription}>
                      <Text style={styles.textTypo2}>2</Text>
                    </Text>
                ...
                <View style={[styles.clockParent, styles.parentFlexBox]}>
                  ...
                  />
                  <Text style={[styles.hours, styles.hoursLayout]}>
              ...
              <View style={styles.frameParent2}>
                <View style={styles.receiptEditParent}>
                  ...
                  />
                  <Text style={[styles.domesticWorker, styles.hoursLayout]}>
                ...
                <View style={styles.home2Parent}>
                  ...
                  />
                  <Text style={[styles.visitEvery2, styles.hoursLayout]}>
                    Visit every 2 weeks
                  </Text>
                </View>
              </View>
      ...
      <View style={[styles.buttonBigParent, styles.homeIndicatorSpaceBlock]}>
        ...
        <View style={styles.sarParent}>
          <Text style={styles.sar}>1200 SAR</Text>
...
export default PinYourLocation9;
