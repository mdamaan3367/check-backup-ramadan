...
const CleaningAndSterilizingTheP8 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432717.png")}
      />
      ...
      <View style={styles.itHelpsFilterTheAirFromDParent}>
        <Text style={[styles.itHelpsFilter, styles.itHelpsFilterTypo]}>
          It helps filter the air from dust and dirt, which helps prevent the
          accumulation of dirt in the internal air conditioner components.
        </Text>
        <Text style={styles.cleanAndReplace}>
          Clean and replace the air filter
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails9")}
        >
...
const styles = StyleSheet.create({
  ...
  itHelpsFilterTheAirFromDParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP8;
