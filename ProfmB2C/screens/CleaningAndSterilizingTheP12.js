...
const CleaningAndSterilizingTheP12 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432729.png")}
      />
      ...
      <View style={styles.aServiceProvidedByProfmToParent}>
        <Text style={[styles.aServiceProvided, styles.serviceTypo]}>
          A service provided by PROFM to customers who suffer from the problem
          of agricultural pests.
        </Text>
        <Text style={[styles.controllingAgriculturalPests, styles.amClr]}>
          Controlling agricultural pests when infested
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails15")}
        >
...
const styles = StyleSheet.create({
  ...
  aServiceProvidedByProfmToParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP12;
