      ...
      <View style={[styles.frameGroup, styles.frameParentLayout]}>
        ...
        >
          <Text style={[styles.inspectShrubsAnd, styles.andTypo]}>
            Inspect shrubs and plant hedges to ensure they are safe and free of
            any damage or disease.
          </Text>
          <Text style={[styles.cutAndShape, styles.andTypo]}>
            Cut and shape shrubs and plant hedges as desired, to maintain their
            beautiful shape and promote healthy growth.
          </Text>
          <Text style={[styles.cutAndShape, styles.andTypo]}>
...
export default ServiceDetails17;
