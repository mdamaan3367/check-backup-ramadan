...
const CleaningAndSterilizingTheP58 = () => {
      ...
      <View style={styles.cleaningAndSterilizingTheP}>
        ...
        <View style={styles.aServiceAimedAtFixingAnyParent}>
          <Text style={[styles.aServiceAimed, styles.serviceTypo]}>
            A service aimed at fixing any problems that curtains may encounter
            at home
          </Text>
          <Text style={styles.curtainIssues}>Curtain issues</Text>
          <Pressable
            style={[styles.frameParent, styles.parentGroupPosition]}
            onPress={() => navigation.navigate("ServiceDetails81")}
          >
...
export default CleaningAndSterilizingTheP58;
