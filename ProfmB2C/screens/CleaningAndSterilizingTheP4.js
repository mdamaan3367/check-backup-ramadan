...
const CleaningAndSterilizingTheP4 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-43279.png")}
      />
      ...
      <View style={styles.checkAllElectricalConnectioParent}>
        <Text style={[styles.checkAllElectrical, styles.serviceDetailsTypo]}>
          Check all electrical connections in the air conditioner to ensure
          their safety and efficiency.
        </Text>
        <Text style={[styles.checkTheUnits, styles.amClr]}>
          Check the unit's electrical connections
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails5")}
        >
...
const styles = StyleSheet.create({
  ...
  checkAllElectricalConnectioParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP4;
