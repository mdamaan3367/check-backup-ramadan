...
const CleaningAndSterilizingTheP37 = () => {
    ...
    <>
      <View style={styles.cleaningAndSterilizingTheP}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/rectangle-43273.png")}
        />
        ...
        <View style={styles.checkTheAirConditionerTherParent}>
          <Text style={[styles.checkTheAir, styles.checkTheAirTypo]}>
            Check the air conditioner thermostat. The thermostat must be intact
            to ensure that the air conditioner is working properly.
          </Text>
          <Text style={styles.checkingTheThermostat}>
            Checking the thermostat
          </Text>
          <Pressable
            style={[styles.frameParent, styles.parentGroupPosition]}
            onPress={() => navigation.navigate("ServiceDetails56")}
          >
...
const styles = StyleSheet.create({
  ...
  checkTheAirConditionerTherParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP37;
