  ...
  return (
    <View style={[styles.pinYourLocation, styles.iconLayout]}>
      ...
      <Property1Default
        ...
        logInWidth="58.31%"
        logInLeft="20.7%"
        onButtonBigPress={() => navigation.navigate("AddNewAddress")}
      />
      <Image
      ...
      <View style={[styles.rectangleParent, styles.rectanglePosition]}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/frame161.png")}
        />
      </View>
      <View style={[styles.rectangleGroup, styles.rectanglePosition]}>
        ...
        <Image
          style={styles.frameIcon1}
          resizeMode="cover"
          source={require("../assets/frame171.png")}
        />
      </View>
    </View>
  );
...
export default PinYourLocation21;
