    ...
    <>
      <View style={styles.serviceDetails}>
        ...
        <Text style={[styles.aMaintenanceService, styles.serviceLayout]}>
          A maintenance service in which the condenser coils are removed from
          the air conditioning unit and cleaned.
        </Text>
        ...
        <View style={[styles.frameGroup, styles.frameParentPosition]}>
          ...
          >
            ...
            <Text
              style={[styles.cleaningCondenserCoils1, styles.condenserTypo]}
            >
...
export default ServiceDetails62;
