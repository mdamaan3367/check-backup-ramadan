...
const CleaningAndSterilizingTheP29 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432766.png")}
      />
      ...
      <View style={styles.waterDrainsAreInspectedForParent}>
        <Text style={[styles.waterDrainsAre, styles.waterDrainsAreTypo]}>
          Water drains are inspected for damage or leaks, and repaired if
          necessary to ensure the safety of the water system.
        </Text>
        <Text style={styles.sewerInspectionAnd}>
          Sewer inspection and repair
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails34")}
        >
...
const styles = StyleSheet.create({
  ...
  waterDrainsAreInspectedForParent: {
    top: 208,
    height: 180,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP29;
