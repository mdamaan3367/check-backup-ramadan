...
const CleaningAndSterilizingTheP30 = () => {
  ...
  return (
    <View style={styles.cleaningAndSterilizingTheP}>
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/rectangle-432768.png")}
      />
      ...
      <View style={styles.waterMotorsAreInspectedForParent}>
        <Text style={[styles.waterMotorsAre, styles.waterMotorsAreTypo]}>
          Water motors are inspected for damage or malfunction, and water flow
          is adjusted as needed to ensure water system efficiency.
        </Text>
        <Text style={[styles.checkWaterMotors, styles.amClr]}>
          Check water motors and adjust water flow
        </Text>
        <Pressable
          style={[styles.frameParent, styles.parentGroupPosition]}
          onPress={() => navigation.navigate("ServiceDetails35")}
        >
          <View style={styles.frameGroup}>
            ...
            />
            <Text style={[styles.serviceDetails, styles.waterMotorsAreTypo]}>
              Service details
            </Text>
          </View>
          <Image
...
const styles = StyleSheet.create({
  ...
  waterMotorsAreInspectedForParent: {
    top: 208,
    height: 196,
    overflow: "hidden",
    backgroundColor: Color.whait,
...
export default CleaningAndSterilizingTheP30;
