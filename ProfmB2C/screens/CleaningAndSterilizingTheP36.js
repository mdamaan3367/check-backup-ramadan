...
const CleaningAndSterilizingTheP36 = () => {
      ...
      <View style={styles.cleaningAndSterilizingTheP}>
        ...
        <View style={styles.removingDirtAndDebrisFromParent}>
          <Text style={[styles.removingDirtAnd, styles.serviceDetailsTypo]}>
            Removing Dirt and Debris from Your Air Conditioner's diffuser must
            be clean to ensure effective air distribution.
          </Text>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("ServiceDetails54")}
          >
...
export default CleaningAndSterilizingTheP36;
