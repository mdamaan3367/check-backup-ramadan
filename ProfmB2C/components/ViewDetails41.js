          ...
          <View style={[styles.frameView, styles.commentsPosition]}>
            ...
            <View style={styles.groupFlexBox}>
              ...
              <View style={[styles.rectangleGroup, styles.groupLayout]}>
                ...
                >
                  <Text
                    style={[styles.steamCleaningMachines, styles.cleaningTypo]}
                  >
        ...
        <View style={[styles.navBarSignUp, styles.navFlexBox]}>
          ...
          <View style={[styles.navBarSignUpChild, styles.framePressableLayout]}>
            <View style={styles.clockParent}>
              ...
              />
              <Text style={[styles.history, styles.cleaningTypo]}>History</Text>
            </View>
          </View>
          <Pressable
