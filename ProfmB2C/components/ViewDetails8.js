...
`}</Text>
                ...
                <View style={styles.frameParent4}>
                  ...
                  <View style={styles.frameWrapper1}>
                    <View style={styles.groupParent}>
                      ...
                      />
                      <Text style={[styles.visits, styles.visitsLayout]}>
              ...
              <View style={[styles.frameParent5, styles.parentFlexBox]}>
                <View style={styles.groupParent}>
                  <Text style={[styles.sar, styles.sarTypo]}>
                    <Text style={styles.cleaning}>{`3700 SAR `}</Text>
                    <Text style={styles.visits2}>{` `}</Text>
                  </Text>
                  <Text style={[styles.sar2, styles.sar2Typo]}>
                    <Text style={styles.cleaning}>{`3960 SAR `}</Text>
                    <Text style={styles.visits2}>{` `}</Text>
                  </Text>
                </View>
                <Pressable
        ...
        <View style={[styles.webViewbottomParent, styles.frameParentPosition]}>
