...
const FormSection1 = ({
  ...
  return (
    <View style={[styles.frameParent, groupView6Style]}>
      <Pressable
        style={[styles.frameGroup, styles.frameGroupBorder]}
          ...
          <View style={styles.frameContainer}>
            <View>
              ...
              <Text style={[styles.hours, styles.sar2Typo]}>
                <Text style={styles.text}>{carImageId}</Text>
            ...
            <View style={[styles.sarParent, styles.parentFlexBox]}>
              <Text style={[styles.sar, styles.sarTypo]}>
                <Text style={styles.text}>{priceLabel}</Text>
      ...
      <View
        style={[styles.off30Wrapper, styles.frameGroupBorder, frameView9Style]}
      >
